...
- (instancetype)initWithSize:(CGSize)size
{
    if (self = [super initWithSize:size])
    {
        ...
        SKSpriteNode *floorPlan = [SKSpriteNode spriteNodeWithImageNamed:@"BeachClub1_zoom"];
        
        SKLabelNode *label = [SKLabelNode labelNodeWithText:@"Beach Club"];
